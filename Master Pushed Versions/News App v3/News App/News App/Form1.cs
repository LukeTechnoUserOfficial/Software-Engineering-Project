...
namespace News_App
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            //Word Extraction
            string extractWords = stuff.Title;
            string Words = extractWords.Substring(extractWords.IndexOf("Item.title"), extractWords.Length - extractWords.IndexOf("Item.title") - 1);
                Words.Replace("title =","");
